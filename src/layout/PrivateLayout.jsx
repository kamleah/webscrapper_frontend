      ...
      <aside className={`bg-[#F2EAE0] min-h-screen p-6 flex flex-col transition-width duration-300 ${isOpen ? 'w-64' : 'w-20'} relative`}>
        ...
        <div className={`flex flex-col items-center mb-10 mt-12`}>
          <div className="flex items-center space-x-2">
            <div className={`text-gradient text-xl font-extrabold text-center text-gray-600 mb-4 transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0'}`}>CRAFT PDP MAKER</div>
          </div>
          <img
