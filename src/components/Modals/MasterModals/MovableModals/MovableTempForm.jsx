...
import { createMovableTemp, editMovableTemp, getMovableTemp } from '../../../../api';
import { useDispatch } from 'react-redux';
import { toast } from 'react-toastify';
import LoadBox from '../../../Loader/LoadBox';
import Error from '../../../Errors/Error';
import { setMovableTemperature } from '../../../../redux/PartnerSlices/storeMoveSlice';


export default function MovableTempForm(props) {
    ...
    // ============================= fetch data  ===================================
    const MovableTempList = () => {
        getMovableTemp().then(res => {
            dispatch(setMovableTemperature(res))
        }).catch(err => {
    ...
    const onSubmit = async (data) => {
        if (props.button !== 'edit') {
            try {
                setLoader(true)
                createMovableTemp(data).then((res) => {
            ...
            try {
                setLoader(true);
                editMovableTemp(props?.data?.id, data).then((res) => {
