...
import { createMovableCity, editMovableCity, getMovableCity } from '../../../../api';
import { useDispatch } from 'react-redux';
import { toast } from 'react-toastify';
import LoadBox from '../../../Loader/LoadBox';
import Error from '../../../Errors/Error';
import { setMovableCity } from '../../../../redux/PartnerSlices/storeMoveSlice';


export default function MovableCityForm(props) {
    ...
    // ========================= fetch data from api ==============================
    const MovableCityList = () => {
        getMovableCity().then(res => {
            dispatch(setMovableCity(res))
        }).catch(err => {
    ...
    const onSubmit = async (data) => {
        if (props?.button !== 'edit') {
            try {
                setLoader(true)
                createMovableCity(data).then((res) => {
            ...
            try {
                setLoader(true);
                editMovableCity(props?.data?.id, data).then((res) => {
